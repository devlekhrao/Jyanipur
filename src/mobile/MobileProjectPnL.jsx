    ...
    return (
      <div className="w-full h-full flex flex-col font-['Poppins'] items-center justify-center p-4">
        <div className="bg-white p-6 rounded-[2rem] border border-zinc-200 shadow-lg w-full text-center space-y-4">
          ...
          <h2 className="text-xl font-extrabold text-zinc-900">Project P&L Reports</h2>
    ...
    <div className="w-full h-full flex flex-col font-['Poppins']">
      ...
      <div className="mb-3 shrink-0">
        <div className="flex justify-between items-center mb-1">
          <div>
            <h2 className="text-2xl font-extrabold text-zinc-900 tracking-tight">Project P&L</h2>
        ...
        <div className="flex-1 overflow-y-auto space-y-3 pb-4 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="bg-white p-3.5 rounded-2xl border border-zinc-200 shadow-sm">
              <span className="text-[8px] font-black text-zinc-400 uppercase tracking-widest block">Contract Budget</span>
              <p className="text-base font-black text-zinc-900 mt-0.5">₹ {pnlData.budget?.toLocaleString('en-IN')}</p>
            </div>

            <div className="bg-emerald-50 p-3.5 rounded-2xl border border-emerald-100 shadow-sm">
              <span className="text-[8px] font-black text-emerald-600 uppercase tracking-widest block">Income Received</span>
              <p className="text-base font-black text-emerald-700 mt-0.5">₹ {pnlData.incomeReceived?.toLocaleString('en-IN')}</p>
            </div>

            <div className="bg-red-50 p-3.5 rounded-2xl border border-red-100 shadow-sm">
              <span className="text-[8px] font-black text-red-500 uppercase tracking-widest block">Total Direct Cost</span>
              <p className="text-base font-black text-red-600 mt-0.5">₹ {pnlData.totalCost?.toLocaleString('en-IN')}</p>
            </div>

            <div className={`p-3.5 rounded-2xl shadow-md ${pnlData.netProfit >= 0 ? 'bg-zinc-900 text-white' : 'bg-red-600 text-white'}`}>
              <span className="text-[8px] font-black uppercase tracking-widest block opacity-80">Net Profit</span>
              <p className="text-base font-black mt-0.5">₹ {pnlData.netProfit?.toLocaleString('en-IN')}</p>
            </div>
          </div>
          ...
          <div className="bg-white border border-zinc-200 p-4 rounded-[1.5rem] shadow-sm space-y-2">
            <div className="flex justify-between items-center">
              <h3 className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Margin Health</h3>
            ...
            <div className="flex justify-between text-[8px] font-black text-zinc-400 uppercase tracking-wider pt-0.5">
          ...
          <div className="bg-white border border-zinc-200 rounded-[1.5rem] p-4 shadow-sm space-y-3">
            <h3 className="text-[10px] font-black text-zinc-400 uppercase tracking-widest border-b border-zinc-100 pb-2">
            ...
            <div className="space-y-2 text-xs">
              <div className="flex justify-between items-center py-1">
                ...
                <span className="font-extrabold text-zinc-900">₹ {pnlData.subCost?.toLocaleString('en-IN')}</span>
              </div>

              <div className="flex justify-between items-center py-1">
                <span className="font-bold text-zinc-700">Site Petty Cash Expenses</span>
                <span className="font-extrabold text-zinc-900">₹ {pnlData.pettyCost?.toLocaleString('en-IN')}</span>
              </div>

              <div className="flex justify-between items-center pt-2 border-t border-zinc-100 font-black">
