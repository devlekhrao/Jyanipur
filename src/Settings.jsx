...
export default function Settings({ companySettings, setCompanySettings }) {
  ...
  // UPDATED: Clean, solid inputs instead of translucent glass
  ...
  // UPDATED: Clean white cards instead of blurred glass
  ...
  return (
    <div className="w-full pb-20 font-['Poppins']">
      <div className="flex justify-between items-end pb-4 border-b border-zinc-200 mb-8">
        <div>
